const album = {
   ...
   */
   ...
   const tracklistWithSeconds = [];

   console.log("The tracklist after adding the durationInSeconds:"); 
   console.log(tracklistWithSeconds);

   /* 
     2. sort the tracks by duration in descending order, from the longer to the shortest one. Save the result in a new array
   */
   ...
   */
    ...
    const albumDurationInSeconds = 0;
